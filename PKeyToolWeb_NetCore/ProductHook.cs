...
namespace PKeyToolWeb_NetCore
{
    public static class ProductHook
    {
        ...
        private static string TARGET_DLL = Path.Combine(Directory.GetCurrentDirectory(), "ProductKeyUtilities.dll");          // 目标系统DLL
        ...
        public static string MainCheckFunc(string ProductKey,string ConfigPath)
        {
            try
            {
                CurrentConfigID="";
